...
const FEATURE_BUSINESS_CARD_CONFIG = [
	...
	},
	{
		...
		description: 'Акт сдачи-приемки оказанных услуг предоставляется в течение **5-ти (пяти)** рабочих дней с начала месяца, следующим за отчетным.<br>Оплата арендной платы производится Арендатором самостоятельно ежемесячно не позднее **15-го** числа месяца, следующего за отчетным.',
	},
	{
		icon: 'blocks',
		title: 'Быстрая интеграция',
		description:
			'Направьте реквизиты вашей организации на электронную почту **partners@hello.by**.<br>Реквизиты должны содержать следующую информацию: УНП, юр. адрес, почтовый адрес, банковские реквизиты, адрес электронной почты, сведения о лице, уполномоченном на подписание договора.',
	},
] as const
