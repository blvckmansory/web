...
const FEATURE_BUSINESS_CARD_CONFIG = [
	...
	},
	{
		...
		description: 'Ежемесячный отчёт предоставляется до **15 числа.** Для заключения договора необходимо отправить нам реквизиты, включающие электронный адрес организации.',
	},
	{
		icon: 'blocks',
